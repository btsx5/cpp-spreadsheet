...
// +(A / B) - always okay (the resulting binary op has the highest grammatic precedence)
    ...
    public:
        ...
        virtual double Evaluate(const CellCalculation& args) const = 0;
    ...
    namespace {
        ...
        public:
            ...
            double Evaluate(const CellCalculation& args) const override {
                double result = 0.0;
                if (type_ == Add) {
...
double FormulaAST::Execute(const CellCalculation& args) const {
